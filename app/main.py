...
#не функциональные кнопки действия у Переработчика, то есть он не может изменить финальный статус

#У ИНСПЕКТОРА ПРИСТУТСВУЕТ ВОЗМОЖНОСТЬ СОЗДАТЬ НОВУЮ ПАРТИЮ - ТАКОГО БЫТЬ НЕ ДОЛЖНО!

#У инспектора отсутсвует возможность экспортировать отчет в exel/csv

#Кнопка назад в партии не работает
